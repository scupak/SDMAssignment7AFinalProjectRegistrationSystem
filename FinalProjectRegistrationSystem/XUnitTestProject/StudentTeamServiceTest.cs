...
namespace XUnitTestProject
{
    public class StudentTeamServiceTest
    {
        ...
        public StudentTeamServiceTest()
        {
            ...
            studentRepoMock.Setup(repo => repo.Add(It.IsAny<Student>())).Callback<Student>(s => allStudents.Add(s.StudentId, s));
            studentRepoMock.Setup(repo => repo.Update(It.IsAny<Student>())).Callback<Student>(s => allStudents[s.StudentId] = s);
            studentRepoMock.Setup(repo => repo.Remove(It.IsAny<Student>())).Callback<Student>(s => allStudents.Remove(s.StudentId));
        ...
        public void AddStudentToTeam_StudentAndTeamExistsStudentNotYetAssigned()
        {
            ...
            Student s1 = new Student() { StudentId = 1 };
            Student s2 = new Student() { StudentId = 2 };
            Student s3 = new Student() { StudentId = 3 };
            Student s4 = new Student() { StudentId = 4 };
        ...
        public void AddStudentToTeam_ToManyStudents_ExpectInvalidOperationException()
        {
            ...
            Student s3 = new Student() { StudentId = 3 };
            Student s4 = new Student() { StudentId = 4 };
            Student s5 = new Student() { StudentId = 5 };
